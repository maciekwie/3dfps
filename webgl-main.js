...
`;
  ...
  const textureShaderProgram = initShaderProgram(gl, tvsSource, tfsSource);
  ...
  const programInfo = {
    ...
    const program2Info = {
      ...
      attribLocations: {
        ...
        vertexNormal: gl.getAttribLocation(textureShaderProgram, "aVertexNormal"),
      ...
      uniformLocations: {
        ...
        normalMatrix: gl.getUniformLocation(textureShaderProgram, "uNormalMatrix"),
    ...
    function render(now) {
        ...
        scene.drawScene(gl, programInfo, program2Info, texture);
